...
public class VehicaalAdapter extends ArrayAdapter<VehicalDataModel> {

    public VehicaalAdapter(Context context, VehicalDataModel[] nameList) {
...
private View initView(int position, View convertView,
        ...
        VehicalDataModel currentItem = getItem(position);
